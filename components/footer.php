<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         ...
         <a href="mailto:immortal@gmail.com"><i class="fas fa-envelope"></i> immortal@gmail.com</a>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>immortal</span> | all rights reserved!</div>
